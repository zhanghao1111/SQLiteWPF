...
{
    /// <summary>
    /// GeneratePDFService 的摘要说明
    /// author: songminghao
    /// date：2019/12/3 8:50:36
    /// desc：生成PDF的服务类
    /// version: 1.0
    /// </summary>

    public class GeneratePDFService : PdfPageEventHelper, IPdfPageEvent
    {
        #region 静态字段
        ...
        public override void OnEndPage(PdfWriter writer, Document document)
        {
            if (PAGE_NUMBER)
            {
                ...
                ColumnText.ShowTextAligned(cb, Element.ALIGN_CENTER, header_right,
                       document.Right - 80 + document.LeftMargin, document.Top + 15, 0);

                ColumnText.ShowTextAligned(cb, Element.ALIGN_CENTER, header_left,
                       document.Right - 520 + document.LeftMargin, document.Top + 15, 0);
        ...
        public override void OnCloseDocument(PdfWriter writer, Document document)
        {
            ...
            tpl.ShowText((writer.PageNumber).ToString());//总页数 
            tpl.EndText();
            tpl.ClosePath();
        }
        #endregion
